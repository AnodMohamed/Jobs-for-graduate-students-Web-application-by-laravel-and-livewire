                    ...
                    @foreach($JobAds as $Jobad)
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                <a href="{{ route('admin.jobad.view',['jobad_id'=>$Jobad->id ]) }}"  id="grid-state"  >
                                    {{ $Jobad->name }}               
                                </a>
                            </td>
                            ...
                            <td class="border px-4 py-2">
                               ...
                               <!-- Button trigger modal -->
                                ...
                                @if ( $Jobad->stauts  == '0')
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-success" data-mdb-toggle="modal" data-mdb-target="#exampleModalActive{{ $Jobad->id }}">
                                    <i class="fa-solid fa-check"></i>
                                </button>

                       
                                <div class="modal top fade" id="exampleModalActive{{ $Jobad->id }}" tabindex="-1" aria-labelledby="exampleModalActive" aria-hidden="true" data-mdb-backdrop="true" data-mdb-keyboard="true">
                                    <div class="modal-dialog   modal-dialog-centered">
                                        <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                        Are you sure you want active {{ $Jobad->name }}
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-danger" data-mdb-dismiss="modal">
                                            No
                                            </button>
                                            <button type="button" class="btn btn-primary" wire:click.prevent="activeJobad({{$Jobad->id}})">Yes</button>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @if ( $Jobad->stauts  == '1')
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-warning" data-mdb-toggle="modal" data-mdb-target="#exampleModalunactive{{ $Jobad->id }}">
                                        <i class="fa-solid fa-ban"></i>
                                    </button>     

                                    <div class="modal top fade" id="exampleModalunactive{{ $Jobad->id }}" tabindex="-1" aria-labelledby="exampleModalunactive" aria-hidden="true" data-mdb-backdrop="true" data-mdb-keyboard="true">
                                        <div class="modal-dialog   modal-dialog-centered">
                                            <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Status Job Ad</h5>
                                            ...
                                            <div class="modal-body">
                                            Are you sure you want unactive {{ $Jobad->name }}
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger" data-mdb-dismiss="modal">
                                                No
                                                </button>
                                                <button type="button" class="btn btn-primary" wire:click.prevent="unactiveJobAd({{$Jobad->id}})">Yes</button>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
