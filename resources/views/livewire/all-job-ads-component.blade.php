                    ...
                    @foreach ($JobAds as $JobAd)
                        <div class="col-md-4 p-4 " >
                            <div class="card">
                                ...
                                <img src="{{ asset('storage/gallery') }}/{{$JobAd->image}}" alt="" class="img-fluid">
                                </div>
                                <div class="card-body">
                                <h5 class="card-title">{{$JobAd->name}}</h5> 
                                <a href="{{ route('jobad.view',['jobad_id'=>$JobAd->id ]) }}" class="btn btn-primary">
                                    Read More
                                </a>
                                </div>
                            </div>
