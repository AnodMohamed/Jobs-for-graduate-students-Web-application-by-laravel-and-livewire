                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $Requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <a href="<?php echo e(route('company.jobad.requests.view',['request_id'=>$Request->id ])); ?>" class=" btn btn-primary" id="grid-state"  >
                                    <i class="fa-solid fa-eye"></i>
                                 </a>
                                  
                                 <?php if( $Request->status  == 'pending'): ?>
                                    <button type="button" class="btn btn-success" wire:click.prevent="addtoNominee(<?php echo e($Request->id); ?>)">
                                        <i class="fas fa-user-plus"></i>
                                    </button>

                            
                                    <button type="button" class="btn btn-warning" wire:click.prevent="reject(<?php echo e($Request->id); ?>)">
...
<?php /**PATH C:\xampp\htdocs\xampp\jfgsb-main\resources\views/livewire/company/company-requests-table-component.blade.php ENDPATH**/ ?>